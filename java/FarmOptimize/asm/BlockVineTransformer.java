 ...
 */
public class BlockVineTransformer implements IClassTransformer, Opcodes{
    private static final String TARGET_CLASS_NAME = "net.minecraft.block.BlockVine";
    @Override
    ...
    private byte[] changeConst(byte[] bytes, String owner) {
        ...
        if (mnode != null)
        {
            ...
            AbstractInsnNode oldInsnNode1 = mnode.instructions.get(9/*7*/);//ICONST_4
            ...
            insnList.add(new FieldInsnNode(GETSTATIC, "FarmOptimize/asm/FarmOptimizeCorePlugin", "growSpeedVine", "I"));
            LabelNode label = (LabelNode)mnode.instructions.get(12/*10*/);//Label 3
            insnList.add(new JumpInsnNode(IFEQ, label));
            mnode.instructions.insert(mnode.instructions.get(6/*4*/), insnList);//After LINENUMBER
